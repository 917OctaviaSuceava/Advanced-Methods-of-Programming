...
import com.example.demo.Domain.exp.*;
import com.example.demo.Domain.state.PrgState;
import com.example.demo.Domain.stmt.*;
...
public class View {
    ...
    public IStmt option8()
    {
        return new CompStmt(new VarDeclStmt("varf", new StringType()),
                        new CompStmt(new AssignStmt("varf", new ValueExp(new StringValue("C:\\Users\\Octavia\\Desktop\\MAP\\demo\\src\\main\\java\\com\\example\\demo\\test.in"))),
    ...
    public void add_state_view(IStmt stmt, int index) throws ADTException {
        PrgState prg = new PrgState(stmt);
        IRepository repo = new Repository("C:\\Users\\Octavia\\Desktop\\MAP\\demo\\src\\main\\java\\com\\example\\demo\\log" + index + ".txt");
